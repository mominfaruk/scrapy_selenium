...
class StartSpider(scrapy.Spider):
    name = "Estate"
    # start_urls = ["https://www.estatemartbd.com/en/145/full?search={%22page_num%22:0,%22v_search_option_79%22:%22Apartment%20-%22,%22v_search_option_64%22:%22%22,%22v_search_option_3%22:%22%22,%22v_search_option_36_from%22:%22%22,%22v_search_option_36_to%22:%22%22,%22v_search_option_20%22:%22%22,%22v_search_option_19%22:%22%22}",
    ...
    def parse(self,response):
        ...
        while True:
            try:
                ...
                #     EC.element_to_be_clickable((By.XPATH,"//ul[@class='pagination']/li[@class='active']//following-sibling::li[1]/a")))
                next_page.click()
            except:
                break
        ...
        """
        next_page = response.css("ul.pagination a").attrib['href']
    ...
    def parse_data(self,response):
        yield {
            ...
            "Price per sqft":[response.css("div.details-info").xpath(f"ul/li[{num}]/span/text()").get(default ="N\A") for num in range(0,11) if response.css("div.details-info").xpath(f"ul/li[{num}]/h4/text()").get()  == "Price Per SqFt:"],
